...
\begin{document}
 ...
 \note[itemize]{
  ...
  \item{who we are - obviously, who we are
        About Veripeditus - What it is, how it was made, and what we plan it to become
        How to create games - How a game in Veripeditus is created
        Framework development and design - What technologies we use and our goals
        State and future - What's already working, planned, and how Veripeditus can be utilized for many different use fields
        You and us and Veripeditus - How you can help, and how to contact us}
 ...
 \note[itemize]{
  ...
  \item{When moving close to the school the NPC spawns. When the player is inside the visible range for the NPC (which, btw, can also be changed) he 
        will see him on his map.}
 }
